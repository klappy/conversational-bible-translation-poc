# Bible Translation Workshop - Current Scope & Limitations

## ✅ What This Workshop CAN Do

This workshop is a **proof of concept** for conversational Bible translation, specifically designed for:

- **Ruth 1:1 (first verse only)**
- Single verse translation workflow
- English source text (Berean Standard Bible)
- 5 specific phrases from Ruth 1:1
- Complete translation process: Settings → Understanding → Drafting → Checking
...
- **Cross-reference support** - Handle parallel passages
...
- Your feedback on the core workflow is most valuable
...
- Accessible translation for non-experts
...
Remember: This is a learning prototype, not a production system. The goal is to explore and refine the conversational translation approach.
